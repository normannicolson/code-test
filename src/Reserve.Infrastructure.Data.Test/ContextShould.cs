...
public class ContextShould
{
    ...
    public async Task FindAvailableRoom_Day_All_Available()
    {
        ...
        (await new ContextShouldContext()
            ...
            .GivenRoom("Grand Hotel", "Room 3")
            .GivenRoom("Grand Hotel", "Room 4")
            .GivenRoom("Grand Hotel", "Room 5")
            .GivenRoom("Grand Hotel", "Room 6")
            ...
            .GivenScheduleRoom("Default", "Room 3", "Grand Hotel")
            .GivenScheduleRoom("Default", "Room 4", "Grand Hotel")
            .GivenScheduleRoom("Default", "Room 5", "Grand Hotel")
            .GivenScheduleRoom("Default", "Room 6", "Grand Hotel")
    ...
    [TestMethod]
    public async Task Two_hotels_FindAvailableRoom_One_Available()
    {
        var friStart = new DateTime(2026, 06, 05, 15, 0, 0);
        var friEnd = new DateTime(2026, 06, 06, 11, 0, 0);
        var satStart = new DateTime(2026, 06, 06, 15, 0, 0);
        ...
        (await new ContextShouldContext()
            ...
            .GivenRoom("Grand Hotel", "Room 1")
            .GivenRoom("Grand Hotel", "Room 2")
            .GivenHotel("Bristol Hotel")
            .GivenRoom("Bristol Hotel", "Room 1")
            .GivenRoom("Bristol Hotel", "Room 2")
            .GivenSlot("Fri", friStart, friEnd)
            .GivenSlot("Sat", satStart, satEnd)
            .GivenSlot("Sun", sunStart, sunEnd)
            .GivenSchedule("Default")
            ...
            .GivenScheduleRoom("Default", "Room 1", "Grand Hotel")
            .GivenScheduleRoom("Default", "Room 2", "Grand Hotel")
            .GivenScheduleRoom("Default", "Room 1", "Bristol Hotel")
            .GivenScheduleRoom("Default", "Room 2", "Bristol Hotel")
            .GivenBooking("Booking 1", friStart, friEnd)
            .GivenBookingRoom("Booking 1", "Room 1")
            .GivenBookingSlot("Booking 1", "Fri")
            .WhenFindAvailableRoomIsCalled(
